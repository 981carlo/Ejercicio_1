...
Atraves del endpoint add_album accedemos al endpoint de búsqueda de la API de Spotify para encontrar nuestro album favorito. El endpoint recibe 2 paramatros. Con el primero, id, indicamos que usuario de la base de datos está haciendo la consulta. En el segundo, q, escribimos el nombre de nuestro album favorito. Si se encuentra el album, el programa introducirá el album favorito y el artista al que pertenece en los campos corespondientes del usuario pasado por parámetro con el id.